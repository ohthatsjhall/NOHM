...
namespace Crosstales.Radio.Demo
{
    ...
    public class AudioSourceController : MonoBehaviour
    {
        ...
        public void VolumeChanged(float value)
        {
            ...
            if (VolumeText != null)
            {
                VolumeText.text = value.ToString(Constants.FORMAT_TWO_DECIMAL_PLACES);
            }
        }
        ...
        public void PitchChanged(float value)
        {
            ...
            if (PitchText != null)
            {
                PitchText.text = value.ToString(Constants.FORMAT_TWO_DECIMAL_PLACES);
            }
        }
        ...
        public void StereoPanChanged(float value)
        {
            ...
            {
                StereoPanText.text = value.ToString(Constants.FORMAT_TWO_DECIMAL_PLACES);
            }
        }
