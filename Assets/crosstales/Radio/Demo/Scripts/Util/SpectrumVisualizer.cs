...
namespace Crosstales.Radio.Demo.Util
{
    ...
    [HelpURL("https://www.crosstales.com/media/data/assets/radio/api/class_crosstales_1_1_radio_1_1_demo_1_1_util_1_1_spectrum_visualizer.html")]
    public class SpectrumVisualizer : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            { //cut the upper frequencies >11000Hz
                ...
                tempCube.GetComponent<Renderer>().material.color = Helper.HSVToRGB((360f / samplesPerChannel) * ii, 1f, 1f, Opacity);
