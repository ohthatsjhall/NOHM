...
namespace Crosstales.Radio.Demo.Util
{
    ...
    [HelpURL("https://www.crosstales.com/media/data/assets/radio/api/class_crosstales_1_1_radio_1_1_demo_1_1_util_1_1_random_scaler.html")]
    public class RandomScaler : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (lerpTime < 1f)
            {
                //lerpTime += Time.deltaTime / changeTime;
