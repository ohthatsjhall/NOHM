...
namespace Crosstales.Radio.Demo
{
    ...
    public class AudioFilterController : MonoBehaviour
    {
        ...
        public void DistortionFilterChanged(float value)
        {
            ...
            {
                DistortionText.text = value.ToString(Constants.FORMAT_TWO_DECIMAL_PLACES);
            }
        }
        ...
        public void LowPassFilterChanged(float value)
        {
            ...
            if (LowpassText != null)
            {
                LowpassText.text = value.ToString(Constants.FORMAT_NO_DECIMAL_PLACES);
            }
        }
        ...
        public void HighPassFilterChanged(float value)
        {
            ...
            {
                HighpassText.text = value.ToString(Constants.FORMAT_NO_DECIMAL_PLACES);
            }
        }
