    ...
    class BitReservoir
    {
        ...
        public bool AddBits(IMpegFrame frame, int overlap)
        {
            ...
            while (--slots >= 0)
            {
                ...
                if (temp == -1) throw new InvalidDataException("Frame did not have enough bytes!");
                _buf[++_end] = (byte)temp;
        ...
        public int GetBits(int count)
        {
            ...
            if (bitsRead < count) throw new InvalidDataException("Reservoir did not have enough bytes!");
        ...
        public int Get1Bit()
        {
            ...
            if (_bitsLeft == 0) throw new InvalidDataException("Reservoir did not have enough bytes!");
