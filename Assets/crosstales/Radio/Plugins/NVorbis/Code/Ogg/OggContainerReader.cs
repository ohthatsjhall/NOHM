...
namespace NVorbis.Ogg
{
    ...
    {
		readonly Crc _crc = new Crc();
		readonly Stream _stream;
		readonly Dictionary<int, PacketReader> _packetReaders;
		readonly List<int> _disposedStreamSerials;
        long _nextPageOffset;
        int _pageCount;

        readonly byte[] _readBuffer = new byte[65025];   // up to a full page of data (but no more!)
        ...
        {
            get { return System.Linq.Enumerable.ToArray(_packetReaders.Keys); }
        }
